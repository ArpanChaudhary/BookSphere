...
public class PDFGenerator {
    ...
    private void addTable(Document document, ReportDto reportDto) throws DocumentException {
        if (reportDto.getData() == null || reportDto.getData().isEmpty()) {
            Font font = FontFactory.getFont(FontFactory.HELVETICA_ITALIC, 12, BaseColor.DARK_GRAY);
        ...
        BaseColor headerBackground = new BaseColor(66, 139, 202); // Bootstrap primary blue
    ...
    private void addSummary(Document document, Map<String, String> summary) throws DocumentException {
        document.add(new Paragraph(" "));
        Font summaryTitleFont = FontFactory.getFont(FontFactory.HELVETICA_BOLD, 12, BaseColor.BLACK);
    ...
    private void addFooter(Document document) throws DocumentException {
        ...
        Font footerFont = FontFactory.getFont(FontFactory.HELVETICA_ITALIC, 8, BaseColor.DARK_GRAY);
